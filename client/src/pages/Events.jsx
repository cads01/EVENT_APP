...
// ── 7XMovies-style spotlight cards section ────────────────────────────────────
      ...
      <div className="pt-20 px-5 md:px-10 pb-5 flex items-center gap-3">
        ...
        {isAdmin && (
          <div className="flex gap-2">
            ...
            <Link to="/admin" className="hidden md:block px-4 py-3 bg-zinc-800 border border-zinc-700 text-zinc-300 rounded-xl text-xs font-bold hover:border-zinc-500 transition-all whitespace-nowrap">Admin</Link>
          </div>
        )}
      </div>
