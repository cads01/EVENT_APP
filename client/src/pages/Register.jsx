  ...
  return (
    <div className="min-h-screen flex bg-zinc-950">
      <div className="hidden md:flex w-1/2 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 rounded-full bg-amber-400/10 blur-3xl translate-x-1/3 -translate-y-1/3" />
        <div className="relative">
          <Link to="/" className="text-white font-black text-2xl">Event<span className="text-amber-400">App</span></Link>
        </div>
        <div className="relative">
          <p className="text-[10px] tracking-[0.35em] uppercase text-amber-400 font-bold mb-3">Join us</p>
          <h2 className="text-5xl font-black text-white leading-none mb-4">Your event<br />journey starts<br />here.</h2>
          <p className="text-zinc-500 text-base max-w-xs">Join thousands of people discovering amazing events every day.</p>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-[10px] tracking-[0.35em] uppercase text-amber-400 font-bold mb-2">Get started</p>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input placeholder="John Doe" className={inputCls}
                onChange={e => setForm(f => ({ ...f, name: e.target.value }))} onKeyDown={onKey} />
            </div>
            <div>
