    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="grid gap-6 xl:grid-cols-3 mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-lg font-bold text-gray-900 mb-3">Past event module</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Once the event is finished, the summary page will show the full recap with photos, posts, comments, and event highlights.
            </p>
            <div className="text-sm text-gray-600 space-y-2">
        ...
        <div className="grid gap-6 xl:grid-cols-2 mb-8">
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              See the timeline for the event day. This helps attendees plan arrival, breaks, and highlights.
            </p>
            <div className="space-y-3 text-sm text-gray-600">
              ...
              <div>
                <p className="font-semibold text-gray-800">Arrival recommendation</p>
                <p>Arrive 15 minutes early for registration and networking.</p>
              </div>
            </div>
          </div>
